...
1. Open the Terminal app (which can be found in your Applications folder) and enter `R`.

2. Next, install the required dependencies: (note: this step only needs to be performed once, the first time you use this app) 
```
